...
public final class ServerLivingEntityEvents {
	 ...
	 * This is fired from {@link class_1309#method_64397}, before armor or any other mitigation are applied.
	...
	/**
	 * An event that is called after an entity is damaged. This is fired from {@link class_1309#method_64397} after damage
	 ...
	 *
	 * <p>Vanilla checks for entity health {@code <= 0} each tick (with {@link class_1309#method_29504()}), and kills if true -
	...
	public interface AllowDamage {
		 ...
		 */
		boolean allowDamage(class_1309 entity, class_1282 source, float amount);
	}
	...
	public interface AfterDamage {
		 ...
		 */
		void afterDamage(class_1309 entity, class_1282 source, float baseDamageTaken, float damageTaken, boolean blocked);
	}
	...
	public interface AllowDeath {
		 ...
		 */
		boolean allowDeath(class_1309 entity, class_1282 damageSource, float damageAmount);
	}
	...
	public interface AfterDeath {
		 ...
		 * @param damageSource the source of the fatal damage
		 */
		void afterDeath(class_1309 entity, class_1282 damageSource);
	}
	...
	public interface MobConversion {
		 ...
		 */
		void onConversion(class_1308 previous, class_1308 converted, class_10179 conversionContext);
	}
